...
// Main Dashboard (landlord, caretaker, tenant, generic staff)
...
router.addRoute('/electrician/dashboard', {
    title: 'Electrician Dashboard',
    auth: true,
    role: ['electrician'],
    component: () => import('./pages/electrician/dashboard.js')
});

router.addRoute('/plumber/dashboard', {
    title: 'Plumber Dashboard',
    auth: true,
    role: ['plumber'],
    component: () => import('./pages/plumber/dashboard.js')
});

router.addRoute('/gardener/dashboard', {
    title: 'Gardener Dashboard',
    auth: true,
    role: ['gardener'],
    component: () => import('./pages/gardener/dashboard.js')
});
// --------------------------------------------------------------------
